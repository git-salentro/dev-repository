...
class Version20180413142422 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE pro_requests CHANGE status status VARCHAR(32) NOT NULL DEFAULT \'in_process\';');
        $this->addSql('ALTER TABLE users CHANGE status status VARCHAR(32) NOT NULL DEFAULT \'not_confirmed\';');
        $this->addSql('ALTER TABLE user_documents CHANGE status status VARCHAR(32) NOT NULL DEFAULT \'Pending\';');
        $this->addSql('ALTER TABLE application_fields CHANGE type type VARCHAR(16) NOT NULL DEFAULT \'text\';');
        $this->addSql('ALTER TABLE properties CHANGE status status VARCHAR(16) DEFAULT NULL DEFAULT \'draft\';');
        $this->addSql('ALTER TABLE property_repost_requests CHANGE status status VARCHAR(16) NOT NULL DEFAULT \'new\', CHANGE note note VARCHAR(255) DEFAULT NULL;');
        ...
        $this->addSql('ALTER TABLE ps_history CHANGE status status VARCHAR(16) NOT NULL DEFAULT \'success\';');
        $this->addSql('ALTER TABLE ps_recurring_payment CHANGE subscription_type subscription_type VARCHAR(255) DEFAULT NULL, CHANGE status status VARCHAR(16) NOT NULL DEFAULT \'Active\', CHANGE type type VARCHAR(255) DEFAULT NULL;');
    }
