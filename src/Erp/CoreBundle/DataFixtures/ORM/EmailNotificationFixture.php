...
class EmailNotificationFixture extends AbstractFixture implements ContainerAwareInterface
{
    ...
    {
        $this->createEmailNotification('SERVICE_REQUESTS','Service Request','eRentPay - New Service Request','','{"0":"#url#"}','Click to see','You have received a new service request from Tenant!');
        $this->createEmailNotification('FORUM_TOPICS','Forum message','eRentPay - New Forum Message','','{"0":"#url#"}','Click to see','There is a new message on Forum!');
        $this->createEmailNotification('PROFILE_MESSAGES','Profile messages','eRentPay - New Profile Message','','{"0":"#url#"}','Click to see','You have received a new message from Tenant.');
    }
