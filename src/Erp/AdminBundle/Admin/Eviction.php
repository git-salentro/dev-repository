...
class Eviction extends Admin
{
    ...
    protected function configureListFields(ListMapper $listMapper)
    {
        $listMapper
            ...
            ->add('template.title', 'string', ['label' => 'Template','template' => 'ErpAdminBundle:Options:list_field_pdf.html.twig'])
    ...
    {
        $datagridMapper->add('properties.address');
        $datagridMapper->add('properties.city.name');
        $datagridMapper->add('properties.city.zip');
    }
}
