...
class ProfileController extends BaseController
{
    ...
    public function detailsAction(Request $request)
    {
            ...
            if ($form->isValid()) {
                ...
                if (!$flag) {
                    ...
                    $this->get('session')->getFlashBag()->add(
                        'alert_ok',
                        $teml . 'has been successfully saved'
                    );
        ...
        return $this->render(
            'ErpUserBundle:Profile:details.html.twig',
    ...
    public function askProAction(Request $request)
    {
        ...
        if ($request->getMethod() === 'POST') {
            ...
            if ($form->isValid() && !$user->isReadOnlyUser()) {
                ...
                if (isset($subjectErr[0])) {
                    $this->get('session')->getFlashBag()->add(
                        'alert_error',
                        $templ . $subjectErr[0]->getMessageTemplate()
                    );
                }
        ...
        return $this->render(
            'ErpUserBundle:Profile/Widgets:ask-pro.html.twig',
    ...
    private function createFormServiceRequest()
    {
        ...
        $formServiceRequest = $this->createForm(
            new DashboardServiceRequestFormType($serviceRequestTypes),
            null,
            $formServiceRequestOptions
        );
