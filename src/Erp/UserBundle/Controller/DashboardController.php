...
class DashboardController extends BaseController
{
    ...
    {
        $integratorKey = $this->getParameter('docusign_integrator_key');
        $email = $this->getParameter('docusign_email');
        $password = $this->getParameter('docusign_password');
        $name = "Mike Borozdin";
        $templateId = "F35087B4-CE90-4C79-8255-2738DF312926";
